...
<tr>
	<td height="20" class="nTime" width="33%"><b class="texto"><?php echo htmlentities($r['pn1']) ?></td>
	<td height="20" width="11%" ><img src="/imagens/paises/<?php echo $r['pi1'] ?>.gif" width="19" height="13" /></td>
	<td height="20" width="11%" class="nTime"><b class="texto">X</td>
	<td height="20" width="11%" ><img src="/imagens/paises/<?php echo $r['pi2'] ?>.gif" width="19" height="13" /></td>
	<td height="20" width="33%" class="nTime"><b class="texto"><?php echo htmlentities($r['pn2']) ?></td>
</tr>
